...
const styles = {
  "pages/index.vue": () => import('./index-styles.B407XTxJ.mjs').then(interopDefault),
  "pages/index.vue?vue&type=style&index=0&lang.css": () => import('./index-styles.B407XTxJ.mjs').then(interopDefault),
